	...
	return (
		<Root className={classes.root}>
			<AppBar className={classes.searchBar} position="static" color="inherit">
				<TextField sx={{ input: { color: 'white' } }} name="search" variant="outlined" label="Search Snapshots" onKeyPress={handleKeyPress} fullWidth value={search} onChangeCapture={(e) => setSearch(e.target.value)} />
